# UTM Coordinate Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:utmconverter-api:1.1.12'
}
```
...
```java
import com.apiverve.utmconverter.UTMCoordinateConverterAPIClient;
import com.apiverve.utmconverter.APIResponse;
import com.apiverve.utmconverter.APIException;

// Initialize the client
UTMCoordinateConverterAPIClient client = new UTMCoordinateConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/utmconverter](https://docs.apiverve.com/ref/utmconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/utmconverter](https://docs.apiverve.com/ref/utmconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/utmconverter-api/issues)
