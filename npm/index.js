...
class utmconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/utmconverter');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/utmconverter';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"direction":{"type":"string","required":false,"default":"to_utm"},"latitude":{"type":"number","required":true,"min":-90,"max":90},"longitude":{"type":"number","required":true,"min":-180,"max":180}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/utmconverter`);
        }
    }
...
module.exports = utmconverterWrapper;
