...
namespace APIVerve.API.UTMCoordinateConverter
{
    ...
    /// <summary>
    /// Client for the UTMCoordinateConverter API
    /// </summary>
    public class UTMCoordinateConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/utmconverter";
        ...
        {
            { "direction", new ValidationRule { Type = "string", Required = false } },
        ...
        public UTMCoordinateConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UTMCoordinateConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UTMCoordinateConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UTMCoordinateConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UTMCoordinateConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(UTMCoordinateConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UTMCoordinateConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UTMCoordinateConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UTMCoordinateConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UTMCoordinateConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UTMCoordinateConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UTMCoordinateConverterQueryOptions options)
        {
