...
// Request contains the parameters for the UTM Coordinate Converter API.
//
// Parameters:
...
type Request struct {
	Direction string `json:"direction,omitempty"` // Optional
...
// ResponseData contains the data returned by the UTM Coordinate Converter API.
...
// OutputData represents the output object.
