...
class TestUtmconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UtmconverterAPIClient(self.api_key)

    @patch('apiverve_utmcoordinateconverter.apiClient.requests.get')
